...
module DELAY_RESET_STATE0_WIDTH16_13 ( x, reset, y, clk, scan_enable, scan_in0, 
  ...
  DFFRHQX1 delay0_reg_15_ ( .D(x[15]), .CK(clk), .RN(n4), .Q(delay0[15]) );
  DFFRHQX1 delay0_reg_14_ ( .D(x[14]), .CK(clk), .RN(n1), .Q(delay0[14]) );
  ...
  DFFRHQX1 delay0_reg_10_ ( .D(x[10]), .CK(clk), .RN(n1), .Q(delay0[10]) );
  ...
  DFFRHQX1 delay0_reg_6_ ( .D(x[6]), .CK(clk), .RN(n4), .Q(delay0[6]) );
