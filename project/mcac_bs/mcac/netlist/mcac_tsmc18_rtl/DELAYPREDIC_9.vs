...
module DELAYPREDIC_9 ( DQN, DQ, RATE, TR, reset, clk, DQN1, B, scan_enable, 
  ...
  DELAY_020_11_9 delay1 ( .x(DQN), .reset(reset), .y(DQN1), .clk(clk), 
  ...
  DELAY_RESET_STATE0_WIDTH16_9 delay2 ( .x(BNR), .reset(reset), .y({n2, 
