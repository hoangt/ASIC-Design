...
module ADAP_SPED_CTL_1 ( I, RATE, TDP, Y, TR, reset, CLK, AL, scan_enable, 
  ...
  DELAY_RESET_STATE0_WIDTH12_1 del ( .x(DMSP), .reset(reset), .y(DMS), .clk(
  ...
  DELAY_RESET_STATE0_WIDTH14_1 del2 ( .x(DMLP), .reset(reset), .y(DML), .clk(
        CLK), .scan_enable(1'b0), .scan_in0(1'b0), .scan_in1(1'b0), .scan_in2(
        1'b0), .scan_in3(1'b0), .scan_in4(1'b0) );
  ...
  DELAY_RESET_STATE0_WIDTH10_1 del3 ( .x(APR), .reset(reset), .y(AP), .clk(CLK), .scan_enable(1'b0), .scan_in0(1'b0), .scan_in1(1'b0), .scan_in2(1'b0), 
