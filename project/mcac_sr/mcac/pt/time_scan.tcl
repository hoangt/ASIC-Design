...
# set design name
#
set design_name  mcac

set my_type "_scan"

#/* set technology library */

set tsmc18 "/classes/eeee720/maieee/lib/tsmc-0.18"
set stdcells5u "../../lib/tech/synopsys"

set search_path [list . [format "%s%s"  $synopsys_root "/libraries/syn"] [format "%s%s" $tsmc18 "/synopsys"] [format "%s%s" $tsmc18 "/model"] ./include ./src]
...
set target_library [list [format "%s%s"  $library_name ".db"]]
